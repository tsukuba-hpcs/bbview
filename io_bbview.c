...
int ompi_io_bbview_generate_current_file_view (struct ompio_file_t *fh,
                                              size_t max_data,
                                              struct iovec **f_iov,
                                              int *iov_count)
{
...
int ompi_io_bbview_sort_offlen (mca_io_ompio_offlen_array_t *io_array,
                               int num_entries,
                               int *sorted){
...
int mca_io_bbview_get_mca_parameter_value ( char *mca_parameter_name, int name_length )
{
